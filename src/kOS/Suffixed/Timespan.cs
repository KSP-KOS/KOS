...
namespace kOS.Suffixed
{
    public class TimeSpan : Structure, IDumper, IComparable<TimeSpan>
    {
        ...
        {
            AddSuffix("YEAR", new Suffix<ScalarIntValue>(CalculateYear));
            AddSuffix("DAY", new Suffix<ScalarIntValue>(CalculateDay));
            AddSuffix("HOUR", new Suffix<ScalarIntValue>(CalculateHour));
            AddSuffix("MINUTE", new Suffix<ScalarIntValue>(CalculateMinute));
            AddSuffix("SECOND", new Suffix<ScalarDoubleValue>(CalculateSecond));
            AddSuffix("SECONDS", new Suffix<ScalarDoubleValue>(() => span));
        ...
        private ScalarIntValue CalculateYear()
        {
