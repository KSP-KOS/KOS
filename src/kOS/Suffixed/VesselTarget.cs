...
namespace kOS.Suffixed
{
    public class VesselTarget : Orbitable, IKOSTargetable
    {
        ...
        private void InitializeSuffixes()
        {
            ...
            AddSuffix("DOCKINGPORTS", new NoArgsSuffix<ListValue>(() => CurrentVessel.PartList("dockingports", Shared)));
            AddSuffix("ELEMENTS", new NoArgsSuffix<ListValue>(() => CurrentVessel.PartList("elements", Shared)));
