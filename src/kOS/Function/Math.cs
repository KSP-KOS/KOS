...
{
    [Function("vcrs", "vectorcrossproduct", ReturnType = typeof(Vector), IsInvariant = true, IsInert = true)]
    ...
    [Function("vdot", "vectordotproduct", ReturnType = typeof(ScalarValue), IsInvariant = true, IsInert = true)]
    ...
    [Function("vxcl", "vectorexclude", ReturnType = typeof(Vector), IsInvariant = true, IsInert = true)]
    ...
    [Function("vang", "vectorangle", ReturnType = typeof(ScalarValue), IsInvariant = true, IsInert = true)]
