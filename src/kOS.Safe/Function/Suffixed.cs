...
{
    [Function("range", ReturnType = typeof(RangeValue), IsInvariant = true, IsInert = true)]
    ...
    [Function("constant", ReturnType = typeof(ConstantValue), IsInvariant = true, IsInert = true)]
