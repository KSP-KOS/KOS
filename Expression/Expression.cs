    ...
    public class Expression
    {
        ...
        private object TryProcessComparison(Term input)
        {
            ...
            for (var i = 0; i < chunks.Count - 1; i++)
            {
                ...
                if (resultValue == null) throw new KOSException("Can't compare " + GetFriendlyNameOfItem(c1.Value) + " to " + GetFriendlyNameOfItem(c2.Value) + " using " + c1.Operator, executionContext);
