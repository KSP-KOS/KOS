...
to use with these statements, including
:ref:`minimizing how many trigger conditions are active <minimize_trigger_conditions>`,
and :ref:`minimizing how long trigger bodies take <minimize_trigger_bodies>`.
It would be a good idea to read that after reading this secion to learn
their syntax.
