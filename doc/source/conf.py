# -*- coding: utf-8 -*-
#
# kOS documentation build configuration file, created by
# sphinx-quickstart on Tue Dec  2 10:52:30 2014.
#
...
project = u'kOS'
copyright = u'2013-2021, Developed and maintained by kOS Team, Originally By Nivekk'
...
# of the sidebar.
html_logo = '_images/kos_logo_small.png'
...
latex_documents = [
  ('index', 'kOS.tex', u'kOS Documentation',
   u'Dunbaratu, erendrake, Originally By Nivekk', 'manual'),
]
...
man_pages = [
    ('index', 'kos', u'kOS Documentation',
     [u'Dunbaratu, erendrake, Originally By Nivekk'], 1)
]
...
texinfo_documents = [
  ('index', 'kOS', u'kOS Documentation',
   u'Dunbaratu, erendrake, Originally By Nivekk', 'kOS', 'One line description of project.',
   'Miscellaneous'),
]
